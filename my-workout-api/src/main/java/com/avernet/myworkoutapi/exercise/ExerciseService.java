...
public class ExerciseService {
    ...
    public List<Exercise> findAll() {
        return exerciseMapper.toDtoList(exerciseRepository.findAllExerciseMuscle());
    }

    @Transactional(readOnly = true)
    public List<Exercise> search(String search) {
        return exerciseMapper.toDtoList(exerciseRepository.searchExercises("%" + search + "%"));
    }

    @Transactional(readOnly = true)
    public List<Exercise> findExercisesByMuscleGroup(Long muscleGroupId) {
        return exerciseMapper.toDtoList(exerciseRepository.findExercisesByMuscleGroup(muscleGroupId));
    }
