...
INSERT INTO public.exercises VALUES (64, 'Mountain climber', 'En position de planche haute, mains au sol sous les épaules, jambes tendues. Amène alternativement les genoux vers la poitrine de façon dynamique, en gardant le tronc gainé. Cet exercice sollicite surtout le bas du grand droit, le transverse et un peu les obliques, tout en faisant travailler le cardio.');
INSERT INTO public.exercises VALUES (65, 'Crunch à la machine', 'Assis sur une machine à crunch, les pieds calés, les mains tenant les poignées ou placées sur la tête selon la machine. En contractant les abdominaux, fléchis le tronc en rapprochant les épaules vers les cuisses, en ciblant le haut du grand droit. Le retour à la position initiale doit être contrôlé.');
...
La descente est lente, avec un bon contrôle de la charge.');
...
INSERT INTO public.exercises VALUES (34, 'Relevé de jambes', 'Installé sur la chaise romaine (peu aussi se faire au sol sur le dos) lever lentement les jambes vers le haut, en contractant surtout le bas du grand droit. Descendre les jambes lentement sans cambrer le bas du dos, en contrôlant le mouvement.');
...
Le tronc est gainé tout au long du mouvement, sans balancement du dos.');
...
INSERT INTO public.exercises VALUES (78, 'Romanian Deadlift (RDL)', 'Le romanian deadlift (ou soulevé de terre roumain) est un exercice super intéressant pour les fessiers et les ischio-jambiers.');
INSERT INTO public.exercises VALUES (79, 'Écartés poulie basse vis-à-vis', 'Aaadkdkdjdjdj');
